...
<!--
| bindrealnameauth       | Handler |              | 获取实名授权的auth_token                                                                                                       | open-type="realnameAuth"   | {%version('1.7.0')%} |
-->
...
<!--
| feedback       | 打开“意见反馈”页面上传用户[日志](./../api/getLogManager.md)，上传的日志可以登录[小程序管理后台](https://mp.weixin.qq.com/)后进入左侧菜单“客服反馈”页面获取到                                                           |{%version('2.1.0')%} |
| getRealnameAuthInfo | 进入实名授权流程，可从bindrealnameauth回调中获取auth_token                          | {% version('1.7.0')%}           |
-->
