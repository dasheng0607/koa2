...
微信设计中心已推出了一套网页标准控件库，包括 [sketch设计控件库][1] 和 [Photoshop设计控件库][2]，后续还将完善小程序组件，这些控件都已充分考虑了移动端页面的特点，能够保证其在移动端页面上的可用性和操作性能；
...
Press 与 Disable 状态分别降低透明度为20%与10%。
...
<ul class="weui_res_download_list" id="weui_res_download_list">
<li class="res_download_item">
    <div class="item_inner">
        <a class="item_link_block" href="https://wximg.gtimg.com/shake_tv/mina/WEUI_1_0_161226_Sketch.zip">
            <i class="res_download_icon icon_sketch"></i>
            <p class="res_download_title">WeUI_sketch组件库</p>
            <a class="res_download_opr" href="https://wximg.gtimg.com/shake_tv/mina/WEUI_1_0_161226_Sketch.zip">下载</a>
        </a>
    </div>
</li>
<li class="res_download_item">
    <div class="item_inner">
        <a class="item_link_block" href="https://wximg.gtimg.com/shake_tv/mina/WeUI1.0.psd.zip">
            <i class="res_download_icon icon_ps"></i>
            <p class="res_download_title">WeUI_PS组件库</p>
            <a class="res_download_opr" href="https://wximg.gtimg.com/shake_tv/mina/WeUI1.0.psd.zip">下载</a>
        </a>
    </div>
</li>
</ul>
...
[1]:    https://wximg.gtimg.com/shake_tv/mina/WEUI_1_0_161226_Sketch.zip
[2]:    https://wximg.gtimg.com/shake_tv/mina/WeUI1.0.psd.zip
[3]:    https://wximg.gtimg.com/shake_tv/mina/WEUI_1_0_161226_Sketch.zip

[image-1]:  ./image/1emphasis.dont.png
[image-2]:  ./image/1emphasis.dont2.png
[image-3]:  ./image/2flow.dont.png
[image-4]:  ./image/3navigation.iOS.png
[image-5]:  ./image/3navigation.color.png
[image-6]:  ./image/3navigation.customize.png
[image-7]:  ./image/3navigation.page.bottom.png
[image-8]:  ./image/3navigation.page.top.png
[image-9]:  ./image/4miniapp.loading.png
[image-10]: ./image/4pull-to-refresh.png
[image-11]: ./image/4loading.page.feedback.png
[image-12]: ./image/4loading.png
[image-13]: ./image/4loading.feedback.png
[image-14]: ./image/4loading.title.png
[image-15]: ./image/5local.feedback.png
[image-16]: ./image/5global.toast.png
[image-17]: ./image/5wording.toast.png
[image-18]: ./image/5global.popup.png
[image-19]: ./image/5global.result.png
[image-20]: ./image/6error.png
[image-21]: ./image/7less-input.png
[image-22]: ./image/7less-input2.png
[image-23]: ./image/8Font.png
[image-24]: ./image/8Font.color.png
[image-25]: ./image/8Font.color2.png
[image-26]: ./image/8Font.color3.png
[image-27]: ./image/9List.png
[image-28]: ./image/10Input.png
[image-29]: ./image/11button.png
[image-30]: ./image/11button2.png
[image-31]: ./image/11button3.png
[image-32]: ./image/11button4.png
[image-33]: ./image/12icon.png
[image-34]: ./image/13titlebar.jpg
