...
![](../image/weanalytics/5_2.png)

填写事件配置，定义如何收集数据：

![](../image/weanalytics/5_3.png)
...
![](../image/weanalytics/5_31.png)

在`viewList`页面和`viewDetail`页面，都有加入购物车按钮`.addToCart`，都需要上报数据到“加入购物车”事件，例子如下：

![](../image/weanalytics/5_32.png)

![](../image/weanalytics/5_33.png)
